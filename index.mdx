...
<ParamField path="BOOTSTRAP_TOKEN" type="string">
...
<ParamField path="DEBUG_DEV" type="boolean">
  Default: `false`
...
<ParamField path="DEBUG_ANSIBLE" type="boolean">
  Default: `false`
...
<ParamField path="USER_DEFAULT_EXPIRED_DAYS" type="number">
  Default: `25550`
...
<ParamField path="SECURITY_VIEW_AUTH_NEED_MFA" type="boolean">
  Default: `true`
